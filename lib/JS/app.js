...
function display_Current_Time() {
    ...
    const countdDays = Math.floor(distance / (1000 * 60 * 60 * 24));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//* ANCHOR -  Ergänzt eine Null, wenn die Zahl unter 10 liegt
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//* ANCHOR - Neuen Countdown speichern
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//* ANCHOR -  Checken, ob Textlänge 25 unterschreitet
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
let txtfieldTxt = "";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//* ANCHOR -  Timer Übersicht
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// Sort countdowns 
function sortedDeadlines(array) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//* ANCHOR -  Render all countdowns
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function renderAllCountdowns() {

    countdowns = sortedDeadlines(countdowns)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//* ANCHOR - Display All Countdown Timer
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function timeDiff(id, dline) {
    ...
    const weeks = getWeeks(countdDays).weeks;
    const restDays = getWeeks(countdDays).restDays;
    ...
    if(timeIsRunning == true) {
        const timeLabel = `${addZeroUnderTen(weeks)} W | ${addZeroUnderTen(restDays)} T | ${addZeroUnderTen(countHours)} Std | ${addZeroUnderTen(countMinutes)} Min | ${addZeroUnderTen(countSeconds)} Sek`;
